---
pagetitle: 'Exercise: Structured Populations - Sensitivity I'
output: 
  html_document:
    toc: FALSE
---
...
In the exercise on the first tab, we found that the dominant eigenvalue of this matrix $\mathsf L$ equals $\lambda=0.952$. Thus, this population is in steep decline.
...
matplot(0:length, t(time.series), type="l", lty=1:3, col = 1:3, ylab = "density", xlab = "time", main="original matrix") # plots result
...
matplot(0:length, t(time.series.f2), type="l", lty=1:3, col = 1:3, ylab = "density", xlab = "time", main="f2 increased")
...
matplot(0:length, t(time.series.f3), type="l", lty=1:3, col = 1:3, ylab = "density", xlab = "time", main="f3 increased")
legend("topright", legend = c("age 1", "age 2", "age 3"), lty = 1:3, col = 1:3, bty = "n")
...
matplot(0:length, t(time.series.s1), type="l", lty=1:3, col = 1:3, ylab = "density", xlab = "time", main="s1 increased")
...
matplot(0:length, t(time.series.f2.prop), type="l", lty=1:3, col = 1:3, ylab = "density", xlab = "time", main="f2 increased")
legend("topright", legend = c("age 1", "age 2", "age 3"), lty = 1:3, col = 1:3, bty = "n")
...
matplot(0:length, t(time.series.f3.prop), type="l", lty=1:3, col = 1:3, ylab = "density", xlab = "time", main="f3 increased")
legend("topleft", legend = c("age 1", "age 2", "age 3"), lty = 1:3, col = 1:3, bty = "n")
...
matplot(0:length, t(time.series.s1.prop), type="l", lty=1:3, col = 1:3, ylab = "density", xlab = "time", main="s1 increased")
legend("topleft", legend = c("age 1", "age 2", "age 3"), lty = 1:3, col = 1:3, bty = "n")
...
matplot(0:length, t(time.series.s2.prop), type="l", lty=1:3, col = 1:3, ylab = "density", xlab = "time", main="s2 increased")
legend("topleft", legend = c("age 1", "age 2", "age 3"), lty = 1:3, col = 1:3, bty = "n")
```
